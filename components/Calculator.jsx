...
export default function Calculator() {
  ...
  return (
    <div style={{
      ...
      color: "#f0ece4", padding: "0", overflowX: "hidden",
    }}>
      <div style={{
        borderBottom: "1px solid #222", padding: "18px 32px",
        display: "flex", alignItems: "center", justifyContent: "space-between",
        background: "#0a0a0a", position: "sticky", top: 0, zIndex: 100,
      }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <div style={{
            width: 32, height: 32, background: "#c8f060",
            display: "flex", alignItems: "center", justifyContent: "center",
            fontWeight: 900, fontSize: 14, color: "#0a0a0a", letterSpacing: "-0.5px",
          }}>CL</div>
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", padding: "48px 24px 80px" }}>
        {step === "segment" && (
          <div style={{ opacity: animIn ? 1 : 0, transform: animIn ? "none" : "translateY(16px)", transition: "all 0.4s ease" }}>
            <div style={{ marginBottom: 48 }}>
              <div style={{
                display: "inline-block", background: "#c8f060", color: "#0a0a0a",
              ...
              <h1 style={{
                ...
                fontWeight: 400, lineHeight: 1.05, margin: "0 0 20px", color: "#f0ece4",
              }}>
                You're probably<br />
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {SEGMENTS.map(s => (
                <button key={s} onClick={() => handleSegment(s)} style={{
                  ...
                  fontSize: 14, fontFamily: "inherit", letterSpacing: "0.02em",
                  transition: "all 0.15s ease", borderRadius: 2,
                }}
            ...
            <div style={{
              marginTop: 48, padding: "20px", border: "1px solid #1e1e1e",
              background: "#111", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20,
            }}>
              {[
        ...
        {step === "calculator" && (
          <div style={{ opacity: animIn ? 1 : 0, transform: animIn ? "none" : "translateY(16px)", transition: "all 0.4s ease" }}>
                  ...
                  <div key={p.id} style={{
                    ...
                    <div style={{ textAlign: "right" }}>
                      <input type="number" min={0}
                        ...
                        placeholder="0"
                        style={{
                          width: 70, background: "#0a0a0a", border: "1px solid #2a2a2a",
                          color: "#f0ece4", padding: "6px 8px", fontSize: 13,
                          fontFamily: "inherit", textAlign: "right", outline: "none", borderRadius: 1,
                        }}
            ...
            {hasQty && (
              <div style={{ border: "1px solid #2a2a2a", background: "#0f0f0f", padding: "28px", marginBottom: 24 }}>
            ...
            {hasQty && !showLead && (
              <button onClick={() => setShowLead(true)} style={{
                width: "100%", padding: "16px", background: "#c8f060", border: "none",
                color: "#0a0a0a", fontSize: 14, fontWeight: 700, fontFamily: "inherit",
                cursor: "pointer", letterSpacing: "0.06em", textTransform: "uppercase", transition: "all 0.15s",
              }}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {[["name", "Your name"], ["company", "Company name"], ["email", "Work email"]].map(([field, placeholder]) => (
                    <input key={field}
                      ...
                      style={{
                        background: "#0a0a0a", border: "1px solid #2a2a2a", color: "#f0ece4",
                        padding: "12px 14px", fontSize: 13, fontFamily: "inherit", outline: "none", borderRadius: 1,
                      }}
                      onFocus={e => e.target.style.borderColor = "#c8f060"}
                      onBlur={e => e.target.style.borderColor = "#2a2a2a"}
                    />
